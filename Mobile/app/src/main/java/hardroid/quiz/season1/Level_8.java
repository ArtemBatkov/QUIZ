...
public class Level_8 extends AppCompatActivity {
    ...
    private ProgressBar timer_level8;
    private TextView timer_txt_level8;
    private Timer timer;
    private Animation a;
    ...
    private int count  = 0;
    private Level8_Array array = new Level8_Array();
    ...
    private void MakeRandom4(){
        ...
        CurrentImage = array.images8[CurrentIndex];
        CurrentImageText = array.text8[CurrentIndex];
    ...
    private void setImageAndAnimation4(){
        a = AnimationUtils.loadAnimation(Level_8.this,R.anim.alpha);
        ImgTask.setImageResource(CurrentImage);
        ImgTask.startAnimation(a);

        a = AnimationUtils.loadAnimation(Level_8.this,R.anim.alpha);
        Answer1.setText(array.text8[PickedValues[0]]);
        Answer1.startAnimation(a);
        a = AnimationUtils.loadAnimation(Level_8.this,R.anim.alpha);
        Answer2.setText(array.text8[PickedValues[1]]);
        Answer2.startAnimation(a);
        a = AnimationUtils.loadAnimation(Level_8.this,R.anim.alpha);
        Answer3.setText(array.text8[PickedValues[2]]);
        Answer3.startAnimation(a);
        a = AnimationUtils.loadAnimation(Level_8.this,R.anim.alpha);
        Answer4.setText(array.text8[PickedValues[3]]);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Level_8.Season1_options options = new Level_8.Season1_options();
        ...
        previewimg.setImageResource(R.drawable.s1_level8_preview);
        ...
        text_preview.setText(R.string.text_s1_level8_description);
        ...
        MainBg.setImageResource(R.drawable.s1_level8_background);
        ...
        //Timer
        timer_level8 = (ProgressBar) findViewById(R.id.timer);
        timer_txt_level8 = (TextView) findViewById(R.id.timer_text);
        timer = new Timer(timer_level8,timer_txt_level8);
        timer_level8.setClickable(false);
        timer_txt_level8.setTextColor(Color.parseColor("#FFFF0049"));
        timer_txt_level8.setShadowLayer(1.6f,1.5f,1.3f,R.color.black);

        timer_level8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                timer_level8.setClickable(false);
        ...
        newtext.setText(R.string.text_s1_level8_description_end);
...
//        newtext.setLayoutParams(params);
        ...
        NewAnime.setAnimation(R.raw.s8);
        NewAnime.setScaleType(ImageView.ScaleType.FIT_CENTER);
        NewAnime.setSpeed(1.15f);
//        dialog_nextlevel.show();
    ...
    private void  gotoGameLevelSeason1(){
        ...
        try {
            PlayMusic.Continue();
            Intent intent = new Intent(Level_8.this, GameLevels_S1.class);
            startActivity(intent); finish();
        }
        catch (Exception exp){}
    }

    private void gotoLevel9(){
        try {
