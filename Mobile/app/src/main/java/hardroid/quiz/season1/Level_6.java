...
public class Level_6 extends AppCompatActivity {
    ...
    private ProgressBar timer_level6;
    private Timer timer;
    private  Level6_Array array = new Level6_Array();
    private Animation a;
    private Dialog dialog_preview,dialog_nextlevel;
    private TextView txt_left_high, txt_left_low, txt_right_high, txt_right_low,timer_txt_level6,button_close,btn_close2;
   ...
   private final int[] progress = {
    ...
    private void setImageAndAnimation4(boolean animation){
        //Left high
        a = AnimationUtils.loadAnimation(Level_6.this,R.anim.alpha);
        imgleft_high.setImageResource(array.images6[value1]);
        if(animation)imgleft_high.startAnimation(a);
        txt_left_high.setText(array.text6[value1]);

        //Right High
        a = AnimationUtils.loadAnimation(Level_6.this,R.anim.alpha);
        imgright_high.setImageResource(array.images6[value2]);
        if(animation)imgright_high.startAnimation(a);
        txt_right_high.setText(array.text6[value2]);

        //Left low
        a = AnimationUtils.loadAnimation(Level_6.this,R.anim.alpha);
        imgleft_low.setImageResource(array.images6[value3]);
        if(animation)imgleft_low.startAnimation(a);
        txt_left_low.setText(array.text6[value3]);

        //Right low
        a = AnimationUtils.loadAnimation(Level_6.this,R.anim.alpha);
        imgright_low.setImageResource(array.images6[value4]);
        if(animation)imgright_low.startAnimation(a);
        txt_right_low.setText(array.text6[value4]);
    }
...
//        ShowArray4();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Level_6.Season1_options options = new Level_6.Season1_options();
        ...
        previewimg.setImageResource(R.drawable.s1_level6_preview);

        //Set new text to preview
        TextView text_preview = (TextView) dialog_preview.findViewById(R.id.text_preview_description);
        text_preview.setText(R.string.text_s1_level6_description);
        dialog_preview.show();
        ...
        MainBg.setImageResource(R.drawable.s1_level6_background);
        ...
        txt_left_high.setTextColor(getResources().getColor(R.color.white));
        txt_left_high.setShadowLayer(1.6f,1.5f,1.3f,R.color.black);
        txt_right_high.setTextColor(getResources().getColor(R.color.white));
        txt_right_high.setShadowLayer(1.6f,1.5f,1.3f,R.color.black);
        txt_left_low.setTextColor(getResources().getColor(R.color.white));
        txt_left_low.setShadowLayer(1.6f,1.5f,1.3f,R.color.black);
        txt_right_low.setTextColor(getResources().getColor(R.color.white));
        txt_right_low.setShadowLayer(1.6f,1.5f,1.3f,R.color.black);


        boolean state =false;
        txt_left_high.setSingleLine(state);
        txt_right_high.setSingleLine(state);
        txt_left_low.setSingleLine(state);
        txt_right_low.setSingleLine(state);
        ...
        //Timer
        timer_level6 = (ProgressBar) findViewById(R.id.timer);
        timer_txt_level6 = (TextView) findViewById(R.id.timer_text);
        timer = new Timer(timer_level6,timer_txt_level6);
        timer_level6.setClickable(false);
        timer_txt_level6.setTextColor(Color.parseColor("#FFFF0049"));
        timer_txt_level6.setShadowLayer(1.6f,1.5f,1.3f,R.color.black);
        timer.ChangeTimer((long)10000,(long)1000);
        timer.TimerInitial();

        timer_level6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                timer_level6.setClickable(false);
        ...
        newtext.setText(R.string.text_s1_level6_description_end);
        ...
        NewAnime.setAnimation(R.raw.s6);
        NewAnime.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
//        dialog_nextlevel.show();
    ...
    private void  gotoGameLevelSeason1(){
        ...
        try {
            PlayMusic.Continue();
            Intent intent = new Intent(Level_6.this, GameLevels_S1.class);
