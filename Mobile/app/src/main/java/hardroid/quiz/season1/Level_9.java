...
public class Level_9 extends AppCompatActivity {
    ...
    private ProgressBar timer_level10;
    private TextView timer_txt_level10;
    private Timer timer;
    public Level9_Array array  = new Level9_Array();

    private Locale locale ;
    private TextView question,button_close,txt_left,txt_right,text_level,btn_close2;
    ...
    private void MakeRandom(){
        FactNum = random.nextInt(40);
        while (History.contains(FactNum)){
            FactNum = random.nextInt(40);
        }
        History.add(FactNum);
        ShowHistory();
        FactNum_answer = array.values9[FactNum];
        question.setText(array.text9[FactNum]);
    }
...
//            tv.setBackgroundColor(getResources().getColor(R.color.black));
    ...
    private void SetImageAndText(boolean animation){
        a = AnimationUtils.loadAnimation(Level_9.this,R.anim.alpha);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Level_9.Season1_options options = new Level_9.Season1_options();
        ...
        text_preview.setText(R.string.text_s1_level9_description);
        ...
        //Timer
        timer_level10 = (ProgressBar) findViewById(R.id.timer);
        timer_txt_level10 = (TextView) findViewById(R.id.timer_text);
        timer = new Timer(timer_level10,timer_txt_level10);
        timer_level10.setClickable(false);
        timer_txt_level10.setText("10");
        timer_level10.setProgress(100);
        timer.ChangeTimer((long)10000,(long)1000);

        doShadow(timer_txt_level10,CommonColor);
        timer_level10.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                timer_level10.setClickable(false);
        ...
        newtext.setText(R.string.text_s1_level9_description_end);
...
//        dialog_nextlevel.show();
    ...
    private void  gotoGameLevelSeason1(){
        ...
        try {
            PlayMusic.Continue();
            Intent intent = new Intent(Level_9.this, GameLevels_S1.class);
