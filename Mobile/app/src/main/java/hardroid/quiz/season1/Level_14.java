...
public class Level_14 extends AppCompatActivity {
    ...
    private Timer timer;
    private ProgressBar timer_level14;
    private TextView text_levels,timer_txt_level14;
    ...
    private Animation a;
    private Level14_Array array = new Level14_Array();

    private void SetImageAndText(boolean animation){
        a = AnimationUtils.loadAnimation(Level_14.this,R.anim.alpha);
        img_left.setImageResource(array.images14[numLeft]);
        if(animation)img_left.startAnimation(a);
        txt_lft.setText(array.text14[numLeft]);

        a = AnimationUtils.loadAnimation(Level_14.this,R.anim.alpha);
        img_right.setImageResource(array.images14[numRight]);
        if(animation)img_right.startAnimation(a);
        txt_rht.setText(array.text14[numRight]);
    }
    private  int count = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Level_14.Season1_options options = new Level_14.Season1_options();
        ...
        img_bgnd.setImageResource(R.drawable.s1_level14_background);
        ...
        //Timers
        timer_level14 = (ProgressBar) findViewById(R.id.timer);
        timer_txt_level14 = (TextView) findViewById(R.id.timer_text);
        timer = new Timer(timer_level14,timer_txt_level14);
        timer_level14.setClickable(false);
        timer_level14.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                timer_level14.setClickable(false);
        ...
        previewimg.setImageResource(R.drawable.s1_level14_preview);

        //Set new text to preview
        TextView text_preview = (TextView) dialog_preview.findViewById(R.id.text_preview_description);
        text_preview.setText(R.string.text_s1_level14_description);
        ...
        newtext.setText(R.string.text_s1_level14_description_end);
        ...
        NewAnime.setAnimation(R.raw.s14);
...
//        dialog_nextlevel.show();
    ...
    private void  gotoGameLevelSeason1(){
        ...
        try {
            PlayMusic.Continue();
            Intent intent = new Intent(Level_14.this, GameLevels_S1.class);
